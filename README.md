...
- **[CLAIMS.md](CLAIMS.md)** maps every guarantee to the file that would go
  ...
  a test no claim points at, fails the suite. Currently 34 claims across 33
...
The suite is **549 tests**, and it is the foundation rather than a census —
...
pytest              # 545 tests, ~103 seconds -- the inner loop
